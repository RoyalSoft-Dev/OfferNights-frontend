      ...
      >
        <Grid item md={10} lg={8} mx="auto">
          ...
          <TypographyH2
            ...
            fontWeight="normal"
          >
            You should verify your phone number and then you can visit our website.<br /> 
            You can confirm the SMS verification code for your phone and then you can inform us via below verification code field.
          </TypographyH2><br />
          <Stack>
            <Link to={''} onClick={onResendClick}>
              <TypographyH2
                ...
                fontWeight="normal"
              >
                Resend Verification Code to {signUpInfo.cell}
              </TypographyH2><br />
            </Link>
